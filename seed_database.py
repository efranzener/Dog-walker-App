...
sitter1 = crud.create_sitter(fname="Michelle", lname= "James", email="michellej@test.com", password="J2wQsncNd7z5", profile_pic="profile_pic", years_of_experience=2, mobile="206-322-4980", street_address="709 Grand Street", zip_code=98136, minute_rate=0.80)
sitter2 = crud.create_sitter(fname="Susan", lname= "Thomas", email="susant@test.com", password="ynBqMYf49VTa", profile_pic="profile_pic", years_of_experience=1, mobile="206-504-4397", street_address= "99 Kirkland Road", zip_code=98133, minute_rate=0.90)
sitter3 = crud.create_sitter(fname="Brian", lname= "Sanchez", email="brians@test.com", password="Hr7XJyZYGTAC", profile_pic="profile_pic", years_of_experience=4, mobile="582-201-4225", street_address="709 Grand Street", zip_code=98118, minute_rate=1.00)
sitter4 = crud.create_sitter(fname="Jared", lname= "Perkins", email="jaredp@test.com", password="LWTDNx2p8ZM9", profile_pic="profile_pic", years_of_experience=5, mobile="206-644-0852", street_address="8839 Sutor Drive", zip_code=98178, minute_rate=0.75)
...
pet_owner1 = crud.create_pet_owner(fname="Yesenia", lname="Orozco", email="yeseniao@test.com", password="2VM6E7rzTht8", profile_pic="profile_pic", num_pets=2, mobile="206-332-0913", street_address="9422 Buttonwood St", zip_code=98136, city='Seattle', state='Washington')    
pet_owner2 = crud.create_pet_owner(fname="Amanda", lname="Hays", email="amandah@test.com", password="uqh7X6pRWTYv", profile_pic="profile_pic", num_pets=1, mobile="206-144-0852", street_address="71 Anderson Lane", zip_code=98178, city='Seattle', state='Washington')    
pet_owner3 = crud.create_pet_owner(fname="Jason", lname="Jacobs", email="jasonj@test.com", password="djMtgQKsG6c8", profile_pic="profile_pic", num_pets=2, mobile="206-201-4225", street_address="40 Parker Ave", zip_code=98118, city='Seattle', state='Washington')    
pet_owner4 = crud.create_pet_owner(fname="Jose", lname="Guzman", email="joseg@test.com", password="3KM2NVU9HtbY", profile_pic="profile_pic", num_pets=1, mobile="315-444-4397", street_address="7669 Foxrun St.", zip_code=98133, city='Seattle', state='Washington')    
...
model.db.session.add_all([pet1, pet2, pet3, pet4]) 
model.db.session.commit()      
...
booking1 = crud.create_booking(weekly=False, pet=pet5, pet_owner=pet_owner3, sitter=sitter3)
booking2 = crud.create_booking(weekly=False, pet=pet6, pet_owner=pet_owner4, sitter=sitter4)

model.db.session.add(booking1) 
model.db.session.commit() 